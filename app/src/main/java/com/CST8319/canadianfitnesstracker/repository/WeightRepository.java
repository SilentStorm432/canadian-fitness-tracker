...
public class WeightRepository implements RepositoryInterfase {
    ...
    public WeightData getWeightData (int userID, String date)
    {
        return dbHelper.getWeightByID(userID, date);
    }
